...
User.create!(name: "Alex", email: "al@example.com", password_digest: "$2a$12$S4d8IjqBJpUUcP4J/7eQTutqkP9srAGiX.d8dehGUtDSB8/z1VUwm", admin: false)
User.create!(name: "Joey", email: "jj@example.com", password_digest: "$2a$12$9OIAMfsByL1UWJUECEE7tehtWOBF8h9XM.JY.YW.YaQ1YJpTsjwA2", admin: false)
